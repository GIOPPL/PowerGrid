...
public class ColorArcProgressBar extends View{
    ...
    private Paint myPaint;//画刻度数字的
//    private Paint myPaint_1;//画刻度数字的
//    private Paint myPaint_2;//画刻度数字的
//    private Paint myPaint_3;//画刻度数字的
//    private Paint myPaint_4;//画刻度数字的
    ...
    int mark;
    int num;
    private int MAX_ELECTRICITY=20000;//最大电量
    private int MIN_ELECTRICITY=0;//最小电量
    private int Num_two;//第二个刻度
    private int Num_three;//第三个刻度
    ...
    public void setELECTRICITY(int MAX_ELECTRICITY,int MIN_ELECTRICITY) {
        this.MAX_ELECTRICITY = MAX_ELECTRICITY;
        this.MIN_ELECTRICITY=MIN_ELECTRICITY;
        countMark();
    }
    ...
    private void initView() {
        ...
        //画刻度数字
        myPaint=new Paint();
        myPaint.setTextSize(dipToPx(13));
        myPaint.setColor(Color.parseColor("#676767"));
        myPaint.setTextAlign(Paint.Align.CENTER);
//        myPaint_1=new Paint();
//        myPaint_1.setTextSize(dipToPx(13));
//        myPaint_1.setColor(Color.parseColor("#676767"));
//        myPaint_1.setTextAlign(Paint.Align.CENTER);
//        myPaint_2=new Paint();
//        myPaint_2.setTextSize(dipToPx(13));
//        myPaint_2.setColor(Color.parseColor("#676767"));
//        myPaint_2.setTextAlign(Paint.Align.CENTER);
//        myPaint_3=new Paint();
//        myPaint_3.setTextSize(dipToPx(13));
//        myPaint_3.setColor(Color.parseColor("#676767"));
//        myPaint_3.setTextAlign(Paint.Align.CENTER);
//        myPaint_4=new Paint();
//        myPaint_4.setTextSize(dipToPx(13));
//        myPaint_4.setColor(Color.parseColor("#676767"));
//        myPaint_4.setTextAlign(Paint.Align.CENTER);
    }
        ...
        if (isNeedDial) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                        switch (num%4){
                            case 0:
                                canvas.drawText(MIN_ELECTRICITY+"",centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE-50,myPaint);
                                num++;
                                break;
                            case 1:
                                canvas.drawText(Num_three+""+"",centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE-50,myPaint);
                                num++;
                                break;
                            case 2:
                                canvas.drawText(Num_two+""+"",centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE-50,myPaint);
                                num++;
                                break;
                            case 3:
                                canvas.drawText(MAX_ELECTRICITY+""+"",centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE-50,myPaint);
                                num++;
                                break;
                        }
    ...
    private void countMark() {
        mark=MAX_ELECTRICITY/3;
        Num_two=MIN_ELECTRICITY+mark;
        Num_three=Num_two+mark;
